...
/// A single chalaan/fine list item — used for the "Chalaan History" of one
/// shopkeeper on the Collection Detail screen.
///
/// Deliberately plainer than [CollectionTile]: history is read-only context,
/// so there's no address, no "Open in Maps" and no collect action.
class ChalaanTile extends StatelessWidget {
  const ChalaanTile({super.key, required this.chalaan, this.onTap});
